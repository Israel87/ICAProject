<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploads.aspx.cs" Inherits="ICA.Member.uploads" %>
...
<head>
	...
	<title>ICA Member - Uploads</title>
               ...
               <%--         <div class="form-group">
                ...
                <div class="panel panel-default">
					...
					<div class="panel-body">
                       ...
                       <div class="col-lg-12">
                           <div class="col-lg-4">
                            <asp:Label ID="uploadone" runat="server"> </asp:Label>
                           </div>
                           <div class="col-lg-4">
                               <asp:Label ID="uploadtwo" runat="server"> </asp:Label>
                           </div>
                           <div class="col-lg-4">
                               <asp:Label ID="uploadthree" runat="server"> </asp:Label>
                           </div> 
                           <br /><br /> <br /><br />
                       </div>
					</div>
