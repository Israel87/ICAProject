...
namespace ICA
{
    public class ConnectionManager
    {
        ...
        // insert individual members to the database
        ...
        // insert student members into the database.
        ...
        // insert corporate members into the database
        internal long saveCorporateData(userModel usermodel)
        {
            long biodataid = 0;
            ...
            try
            {
                using (OracleConnection conn = getConnection())
                {
                    using (OracleCommand cmd = new OracleCommand("INSERTCORPORATEDATA", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        // CorporateData 
                        cmd.Parameters.Add(new OracleParameter("V_POSITION", OracleDbType.Varchar2, usermodel.companyInfo.Position, ParameterDirection.Input));
                        cmd.Parameters.Add(new OracleParameter("V_COMPANYNAME", OracleDbType.Varchar2, usermodel.companyInfo.CompanyName, ParameterDirection.Input));
                        cmd.Parameters.Add(new OracleParameter("V_COMPANYADDRESS", OracleDbType.Varchar2, usermodel.companyInfo.CompanyAddress, ParameterDirection.Input));
                        cmd.Parameters.Add(new OracleParameter("V_COMPANYEMAIL", OracleDbType.Varchar2, usermodel.companyInfo.CompanyEmail, ParameterDirection.Input));
                        cmd.Parameters.Add(new OracleParameter("V_WEBADDRESS", OracleDbType.Varchar2, usermodel.companyInfo.WebAddress, ParameterDirection.Input));
