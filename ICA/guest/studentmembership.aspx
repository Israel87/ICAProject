...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%--  <div class="container text-center">--%>
       ...
       <br />
          <asp:HyperLink ID="studentReg" runat="server" Font-Bold="true" CssClass="btn btn-info btn-md" Width="300px" NavigateUrl="~/guest/registrationProcess.aspx" style="border-radius:0px">REGISTER</asp:HyperLink>
