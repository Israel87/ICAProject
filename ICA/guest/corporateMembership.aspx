            ...
            <div class="row col-md-12" style="padding-left: 100px">
                <div class="col-md-4 text-center">
                    ...
                    <div class="input-group">
                        ...
                        <asp:HyperLink ID="corpID" runat="server" Font-Bold="true" CssClass="btn btn-success btn-md" Width="300px" NavigateUrl="~/guest/registrationProcess.aspx" style="border-radius:0px">Click to Choose</asp:HyperLink><br /><br />
                  ...
                  <div class="row col-md-4 text-center" >
                    <div class="input-group">
                        <img src="../images/Gold.png" style="width: 80px; height: 80px;" />
                              ...
                              <br /><br />
                        <asp:HyperLink ID="corpIDI" runat="server" Font-Bold="true" CssClass="btn btn-success btn-md" Width="300px" NavigateUrl="~/guest/registrationProcess.aspx" style="border-radius:0px">Click to Choose</asp:HyperLink><br /><br />
                 ...
                 <div class="col-md-4 text-center">
                        ...
                        <div class="input-group">
                         ...
                         <br /><br />
                        <asp:HyperLink ID="corpIDII" runat="server" Font-Bold="true" CssClass="btn btn-success btn-md" Width="300px" NavigateUrl="~/guest/registrationProcess.aspx" style="border-radius:0px">Click to Choose</asp:HyperLink><br /><br />
